...
def run(data,
    ...
    def box_list_(dict_data):
        '''
        이 함수는 위에서 나온 결과 가지고 submission.csv에 PredictionString에
    ...
    sbm_test.to_csv('./submission_yolov5x.csv', index=None)
...
def parse_opt():
    ...
    parser.add_argument('--subm', type=str, default='yes', help='yes is get submission.csv')
